...
@XmlRootElement(name = "ConsultaSolicitudDeServicioProcessResponse")
public class ConsultaSolicitudDeServicioProcessResponse {
    ...
    protected List<ConsultaSolicitudDeServicioProcessResponse.DetalleSolicitudDeServicio> detalleSolicitudDeServicio;
     ...
     * {@link ConsultaSolicitudDeServicioProcessResponse.DetalleSolicitudDeServicio }
     *
     *
     */
    public List<ConsultaSolicitudDeServicioProcessResponse.DetalleSolicitudDeServicio> getDetalleSolicitudDeServicio() {
        if (detalleSolicitudDeServicio == null) {
            detalleSolicitudDeServicio =
                new ArrayList<ConsultaSolicitudDeServicioProcessResponse.DetalleSolicitudDeServicio>();
        }
    ...
    @XmlType(name = "",
             propOrder =
             { "numeroDeSolicitud", "area", "subAarea", "comentario", "tarjetaInteligente", "fechaCreacion", "estatus"
        })
