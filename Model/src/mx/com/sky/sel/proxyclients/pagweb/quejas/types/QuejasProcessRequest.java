 ...
 *         &lt;element name="Quejas" type="{http://www.w3.org/2001/XMLSchema}string"/&gt;
...
@XmlType(name = "", propOrder = { "userID", "quejas", "tipoConsulta", "numeroSS" })
@XmlRootElement(name = "QuejasProcessRequest")
public class QuejasProcessRequest {

    @XmlElement(required = true)
    protected String userID;
    @XmlElement(name = "Quejas", required = true)
    protected String quejas;
    ...
    /**
     * Sets the value of the quejas property.
     *
     * @param value
     *     allowed object is
     *     {@link String }
     *
     */
    public void setQuejas(String value) {
        this.quejas = value;
    }
