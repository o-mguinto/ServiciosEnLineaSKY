...
@XmlType(name = "", propOrder = { "resultado", "resultadodesc", "noSolicitud" })
@XmlRootElement(name = "ExecPromesaDePagoProcessResponse")
public class ExecPromesaDePagoProcessResponse {
