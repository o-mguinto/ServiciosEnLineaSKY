...
@XmlType(name = "", propOrder = { "tarjetaInteligente" })
@XmlRootElement(name = "ConsultaCambiosPendientesModulosProcessRequest")
public class ConsultaCambiosPendientesModulosProcessRequest {
