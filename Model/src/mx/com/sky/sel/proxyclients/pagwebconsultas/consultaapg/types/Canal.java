...
@XmlType(name = "Canal", propOrder = { "identificador", "idMostrado", "canalNombre", "nombre", "descripcion" })
public class Canal {

    @XmlElementRef(name = "Identificador", namespace = "http://xmlns.oracle.com/consultaProgramacion",
                   type = JAXBElement.class, required = false)
    protected JAXBElement<String> identificador;
    @XmlElementRef(name = "IdMostrado", namespace = "http://xmlns.oracle.com/consultaProgramacion",
                   type = JAXBElement.class, required = false)
    protected JAXBElement<String> idMostrado;
    @XmlElementRef(name = "CanalNombre", namespace = "http://xmlns.oracle.com/consultaProgramacion",
                   type = JAXBElement.class, required = false)
    protected JAXBElement<String> canalNombre;
    @XmlElementRef(name = "Nombre", namespace = "http://xmlns.oracle.com/consultaProgramacion",
                   type = JAXBElement.class, required = false)
    protected JAXBElement<String> nombre;
    @XmlElementRef(name = "Descripcion", namespace = "http://xmlns.oracle.com/consultaProgramacion",
                   type = JAXBElement.class, required = false)
