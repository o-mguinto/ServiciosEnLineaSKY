...
@XmlType(name = "", propOrder = { "tarjetaInteligente", "cuentaSKY", "sistema" })
@XmlRootElement(name = "ConsultaPPEContratadosProcessRequest")
public class ConsultaPPEContratadosProcessRequest {
