 ...
 *         &lt;element name="lada" type="{http://www.w3.org/2001/XMLSchema}string" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "", propOrder = { "resultado", "resultadodesc", "lada" })
@XmlRootElement(name = "ConsultaLadasProcessResponse")
public class ConsultaLadasProcessResponse {
     ...
     * This is why there is not a <CODE>set</CODE> method for the lada property.
     *
     * <p>
     ...
     *
     */
    public List<String> getLada() {
        if (lada == null) {
            lada = new ArrayList<String>();
        }
        return this.lada;
    }
