...
@XmlType(name = "", propOrder = { "resultado", "resultadodesc", "status" })
@XmlRootElement(name = "ConsultaStatusPreregistroProcessResponse")
public class ConsultaStatusPreregistroProcessResponse {
