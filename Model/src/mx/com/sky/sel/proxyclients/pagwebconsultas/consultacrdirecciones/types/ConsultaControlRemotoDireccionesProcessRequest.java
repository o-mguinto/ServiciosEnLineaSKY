...
@XmlType(name = "", propOrder = { "idRegion" })
@XmlRootElement(name = "ConsultaControlRemotoDireccionesProcessRequest")
public class ConsultaControlRemotoDireccionesProcessRequest {
