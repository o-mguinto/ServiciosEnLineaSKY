 ...
 *         &lt;element name="Solicitudes" type="{http://cambiotitular.serviciosenlinea.sky.com.mx}CTSSOutType" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "", propOrder = { "resultado", "resultadodesc", "solicitudes" })
@XmlRootElement(name = "CTSSOut")
public class CTSSOut {
    ...
    protected List<CTSSOutType> solicitudes;
     ...
     *
     */
    public List<CTSSOutType> getSolicitudes() {
        if (solicitudes == null) {
            solicitudes = new ArrayList<CTSSOutType>();
        }
