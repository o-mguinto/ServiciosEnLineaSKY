...
public class ConsultaCoberturaSoaInterface_ptClient {
    public static void main(String[] args) {
        ConsultaCoberturaSoaInterfaceEp consultaCoberturaSoaInterfaceEp = new ConsultaCoberturaSoaInterfaceEp();
        ConsultaCoberturaSoaInterface consultaCoberturaSoaInterface =
            consultaCoberturaSoaInterfaceEp.getConsultaCoberturaSoaInterfacePt();
