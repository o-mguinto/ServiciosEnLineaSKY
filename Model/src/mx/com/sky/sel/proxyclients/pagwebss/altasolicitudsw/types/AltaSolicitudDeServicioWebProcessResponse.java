...
@XmlType(name = "", propOrder = { "resultado", "resultadodesc", "numeroSolicitud" })
@XmlRootElement(name = "AltaSolicitudDeServicioWebProcessResponse")
public class AltaSolicitudDeServicioWebProcessResponse {
