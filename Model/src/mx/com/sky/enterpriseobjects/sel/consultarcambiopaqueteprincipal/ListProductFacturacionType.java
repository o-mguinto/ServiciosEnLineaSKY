...
@XmlType(name = "ListProductFacturacion_Type", propOrder = { "productFacturacion" })
public class ListProductFacturacionType {
    ...
    public List<ListProductFacturacionType.ProductFacturacion> getProductFacturacion() {
        if (productFacturacion == null) {
            productFacturacion = new ArrayList<ListProductFacturacionType.ProductFacturacion>();
        }
     ...
     */
    @XmlAccessorType(XmlAccessType.FIELD)
    @XmlType(name = "", propOrder = { "nombreProductoFactura", "partNumberFactura" })
