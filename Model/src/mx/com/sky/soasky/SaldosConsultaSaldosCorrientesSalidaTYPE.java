...
@XmlType(name = "Saldos_consultaSaldosCorrientes_Salida_TYPE",
         propOrder =
         { "cabecera", "adeudo", "cpr", "saldominimo", "prorrateo", "cnr",
           "ppvxf", "saldoporfacturar", "saldototal", "descuento",
           "fechapromocion", "promocion", "numerofactura", "fechaemision",
           "tipobanco", "status", "descuentopagooportuno", "totalpagooportuno",
           "saldototalpagooportuno", "fechapagooportuno", "tipotarjeta",
           "fechasiguientecorte", "cargorecxfac", "fechabloqueosuave"
    })
public class SaldosConsultaSaldosCorrientesSalidaTYPE {
    ...
    @XmlElementRef(name = "DESCUENTO_PAGO_OPORTUNO",
                   namespace = "http://www.sky.com.mx/soasky",
                   type = JAXBElement.class, required = false)
    protected JAXBElement<String> descuentopagooportuno;
    @XmlElementRef(name = "TOTAL_PAGO_OPORTUNO",
                   namespace = "http://www.sky.com.mx/soasky",
                   type = JAXBElement.class, required = false)
    protected JAXBElement<String> totalpagooportuno;
    @XmlElementRef(name = "SALDO_TOTAL_PAGO_OPORTUNO",
                   namespace = "http://www.sky.com.mx/soasky",
                   type = JAXBElement.class, required = false)
    protected JAXBElement<String> saldototalpagooportuno;
    @XmlElementRef(name = "FECHA_PAGO_OPORTUNO",
                   namespace = "http://www.sky.com.mx/soasky",
                   type = JAXBElement.class, required = false)
    protected JAXBElement<String> fechapagooportuno;
    @XmlElementRef(name = "TIPO_TARJETA",
                   namespace = "http://www.sky.com.mx/soasky",
                   type = JAXBElement.class, required = false)
    ...
    @XmlElement(name = "FECHA_BLOQUEO_SUAVE")
    protected String fechabloqueosuave;
    ...
    public void setDESCUENTOPAGOOPORTUNO(JAXBElement<String> value) {
        this.descuentopagooportuno = value;
    }
    ...
    public void setSALDOTOTALPAGOOPORTUNO(JAXBElement<String> value) {
        this.saldototalpagooportuno = value;
    }
    ...
    /**
     * Gets the value of the fechabloqueosuave property.
     *
     * @return
     * possible object is
     * {@link String}
     *
     */
    public String getFECHABLOQUEOSUAVE() {
        return fechabloqueosuave;
    }

    /**
     * Sets the value of the fechabloqueosuave property.
     *
     * @param value
     * allowed object is
     * {@link String}
     *
     */
    public void setFECHABLOQUEOSUAVE(String value) {
        this.fechabloqueosuave = value;
    }
