 ...
 *         &lt;element name="emailNotificacion" type="{http://www.w3.org/2001/XMLSchema}string"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "DatosTransaccionPagoInputMessageType",
         propOrder =
         { "phaseId", "keyId", "fechaPago", "horaPago", "montoPago",
           "propositoPago", "pais", "token", "codigoMoneda", "descripcion",
           "cuentaSky", "organizacionId", "metodoPago", "servicio",
           "emailNotificacion"
    })
