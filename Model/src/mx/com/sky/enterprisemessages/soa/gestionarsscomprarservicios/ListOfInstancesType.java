 ...
 *                   &lt;element name="ListOfProducts" type="{http://www.sky.com.mx/EnterpriseMessages/Soa/GestionarSSComprarServicios}ListOfProducts_Type" minOccurs="0"/&gt;
 *                 &lt;/sequence&gt;
 *               &lt;/restriction&gt;
 *             &lt;/complexContent&gt;
 *           &lt;/complexType&gt;
...
public class ListOfInstancesType {
     ...
     */
    @XmlAccessorType(XmlAccessType.FIELD)
    @XmlType(name = "", propOrder = { "assetNumber", "secondAssetNumber", "listOfProducts" })
