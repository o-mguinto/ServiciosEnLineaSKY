 ...
 *         &lt;element name="TransportStreamId" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/&gt;
 ...
 *         &lt;element name="ContentProviderId" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/&gt;
...
@XmlType(name = "Evento",
         propOrder =
         { "tipo", "titulo", "duracion", "fechainicio", "fechaFinal",
           "sinopsis", "contentId", "transportStreamId", "eventId", "seriesId",
           "programId", "contentProviderId", "networkId"
    })
public class Evento {
    ...
    @XmlElementRef(name = "Duracion",
                   namespace =
                   "http://www.sky.com.mx/EnterpriseMessages/Sel/ConsultaParrillaGuiaSky",
                   type = JAXBElement.class, required = false)
    protected JAXBElement<BigDecimal> duracion;
    @XmlElementRef(name = "Fechainicio",
                   namespace =
                   "http://www.sky.com.mx/EnterpriseMessages/Sel/ConsultaParrillaGuiaSky",
                   type = JAXBElement.class, required = false)
    protected JAXBElement<XMLGregorianCalendar> fechainicio;
    @XmlElementRef(name = "FechaFinal",
                   namespace =
                   "http://www.sky.com.mx/EnterpriseMessages/Sel/ConsultaParrillaGuiaSky",
                   type = JAXBElement.class, required = false)
    protected JAXBElement<XMLGregorianCalendar> fechaFinal;
    @XmlElementRef(name = "Sinopsis",
                   namespace =
                   "http://www.sky.com.mx/EnterpriseMessages/Sel/ConsultaParrillaGuiaSky",
                   type = JAXBElement.class, required = false)
    protected JAXBElement<String> sinopsis;
    @XmlElementRef(name = "ContentId",
                   namespace =
                   "http://www.sky.com.mx/EnterpriseMessages/Sel/ConsultaParrillaGuiaSky",
                   type = JAXBElement.class, required = false)
    protected JAXBElement<String> contentId;
    @XmlElementRef(name = "TransportStreamId",
                   namespace =
                   "http://www.sky.com.mx/EnterpriseMessages/Sel/ConsultaParrillaGuiaSky",
                   type = JAXBElement.class, required = false)
    protected JAXBElement<String> transportStreamId;
    @XmlElementRef(name = "EventId",
                   namespace =
                   "http://www.sky.com.mx/EnterpriseMessages/Sel/ConsultaParrillaGuiaSky",
                   type = JAXBElement.class, required = false)
    protected JAXBElement<String> eventId;
    @XmlElementRef(name = "SeriesId",
                   namespace =
                   "http://www.sky.com.mx/EnterpriseMessages/Sel/ConsultaParrillaGuiaSky",
                   type = JAXBElement.class, required = false)
    protected JAXBElement<String> seriesId;
    @XmlElementRef(name = "ProgramId",
                   namespace =
                   "http://www.sky.com.mx/EnterpriseMessages/Sel/ConsultaParrillaGuiaSky",
                   type = JAXBElement.class, required = false)
    protected JAXBElement<String> programId;
    @XmlElementRef(name = "ContentProviderId",
                   namespace =
                   "http://www.sky.com.mx/EnterpriseMessages/Sel/ConsultaParrillaGuiaSky",
                   type = JAXBElement.class, required = false)
    protected JAXBElement<String> contentProviderId;
    @XmlElementRef(name = "NetworkId",
                   namespace =
                   "http://www.sky.com.mx/EnterpriseMessages/Sel/ConsultaParrillaGuiaSky",
                   type = JAXBElement.class, required = false)
    ...
    /**
     * Gets the value of the transportStreamId property.
     *
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
     *
     */
    public JAXBElement<String> getTransportStreamId() {
        return transportStreamId;
    }

    /**
     * Sets the value of the transportStreamId property.
     *
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
     *
     */
    public void setTransportStreamId(JAXBElement<String> value) {
     ...
     *
     */
    public JAXBElement<String> getContentProviderId() {
     ...
     *
     */
    public void setContentProviderId(JAXBElement<String> value) {
